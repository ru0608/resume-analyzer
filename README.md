...
| 模块 | 功能 | 状态 |
|------|------|------|
| 📤 简历上传与解析 | PDF 上传、文本提取、清洗结构化 | ✅ 必选 |
| 🤖 关键信息提取 | AI 提取姓名/电话/邮箱/地址/求职意向等 | ✅ 必选 + ⭐ 加分 |
| 📊 简历评分与匹配 | 岗位需求匹配度计算、AI 精准评分 | ✅ 必选 + ⭐ 加分 |
| ⚡ 结果返回与缓存 | JSON 结构化返回、Redis/内存缓存 | ✅ 必选 + ⭐ 加分 |
| 🎨 前端页面 | React + Vite 交互页面，部署到 GitHub Pages | ✅ 必选 |
